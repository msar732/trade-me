...
if __name__ == "__main__":
    print("🚀 Trade India AI Engine - Fixed Backup Application")
    print("=" * 60)
    ...
    fraud_analysis = fraud_detector.analyze_listing(sample_listing)
    print(f"Fraud Score: {fraud_analysis['overall_score']:.2f}")
    print(f"Risk Level: {fraud_analysis['risk_level']}")
    
    # Test price prediction
    print("\n💰 Testing Price Prediction...")
    price_analysis = price_predictor.predict_price(sample_listing)
    print(f"Predicted Price: ₹{price_analysis['predicted_price']:,.0f}")
    print(f"Confidence: {price_analysis['confidence']:.2f}")
    
    # Test recommendations
    print("\n🎯 Testing Recommendations...")
    recommendations = recommendation_engine.get_recommendations({'id': 1}, limit=5)
    print(f"Found {len(recommendations)} recommendations")
    
    # Test AI model retraining
    print("\n🔄 Testing AI Model Retraining...")
    retrain_result = retrain_ai_models()
    print(f"Retraining Result: {retrain_result['success']}")
    if retrain_result['success']:
        print(f"Message: {retrain_result['message']}")
    else:
        print(f"Error: {retrain_result['error']}")
    
    print("\n🎉 All tests completed successfully!")
    print("=" * 60)
    print("✅ Trade India AI Engine - Backup Fixed and Ready!")
